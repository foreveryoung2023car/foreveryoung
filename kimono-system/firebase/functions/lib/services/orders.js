...
import { HttpError, assertTransition } from "../lib/constants.js";
...
export async function createPublicOrder(raw) {
    ...
    const result = await db.runTransaction(async (tx) => {
        ...
        const storeId = input.storeCode || null;
...
export async function transitionOrder(orderId, nextStatus, actor) {
    const result = await db.runTransaction(async (tx) => {
